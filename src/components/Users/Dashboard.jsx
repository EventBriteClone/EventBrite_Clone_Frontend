        ...
        <div className={Style["container"]}>
          ...
          <div className={Style["cards"]}>
            <div className={Style["card"]}>
              <div className={Style["details"]}>
                <div className={Style["sales-tickets-views"]}>
                  <h2>Net Sales</h2>
                </div>
          ...
          <div className={Style["mid-section"]}>
            ...
            <div className={Style["right-list"]}>
              ...
              <div className={Style["account-publish"]}>
                <div className={Style["event-account"]}>
                  <div className={Style["paid"]}>
                    <i className={Style["ri-bank-card-line"]} />
                  </div>
                  <div className={Style["review-account"]}>
                ...
                <div className={Style["event-account"]}>
                  <div className={Style["paid"]}>
                    <i className={Style["ri-inbox-unarchive-line"]} />
                  </div>
                  <div className={Style["review-account"]}>
              ...
              <div className={Style["account-publish"]}>
                <div className={Style["event-account"]}>
                  <div className={Style["paid Ads"]}>
                    <i className={Style["fas fa-bullhorn"]} />
                  </div>
                  <div className={Style["review-account Ads"]}>
          ...
          <div className={Style["mid-section two"]}>
            <div className={Style["share"]}>
              <div className={Style["text"]}>
                <h3>Sales by ticket type</h3>
              </div>
              <div className={Style["url-link tickets"]}>
                <div className={Style["url"]}>
                  <p>Ticket type</p>
                </div>
                <div className={Style["url ticket"]}>
                  <p>Price</p>
                  <p>Sold</p>
                </div>
              </div>
              <div className={Style["url-link tickets"]}>
                <div className={Style["url addm"]}>
                  <p>General Admission</p>
                </div>
                <div className={Style["url price"]}>
                  <p>$20.00</p>
                  <a href="#">0/12</a>
                </div>
              </div>
              <div className={Style["line two"]}>
                <hr />
              </div>
            </div>
            <div className={Style["right-list down"]}>
              <div className={Style["other-attende"]}>
                <p>Other Attendee Actions</p>
              </div>
              <div className={Style["attende-responses"]}>
                <a href="#">
                  <i className={Style["ri-line-chart-line"]} />
                  Attendee summary report
                </a>
                <br />
                <br />
                <a href="#">
                  <i className={Style["ri-message-3-line"]} />
          ...
          <div className={Style["mid-section two three"]}>
            <div className={Style["share"]}>
              <div className={Style["text orders"]}>
                <h3>Recent Orders</h3>
              </div>
              ...
              <div className={Style["note"]}>
                ...
                <p className={Style["eds-text-bm eds-align--center"]}>
                  No orders for this event yet
                </p>
              </div>
              <div className={Style["go-to all-orders"]}>
