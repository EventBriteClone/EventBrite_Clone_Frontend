...
import styles from "./PromoCodeDrawer.module.css";
      ...
      <Box className={styles["box-container"]}>
        ...
        <DrawerHeader>
          <div className={styles["add-ticket-container"]}>
            <h3 className={styles["add-ticket-h3"]}>Add code</h3>
          </div>
        </DrawerHeader>
        <Divider />
        <List>
...
PromoCodeDrawer.propTypes = {
  closePromoCodeDrawer: PropTypes.func,
  promoCodeList: PropTypes.array,
  setPromoCodeList: PropTypes.func,
